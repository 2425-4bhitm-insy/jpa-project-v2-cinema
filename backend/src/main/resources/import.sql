...
INSERT INTO Employee (name, email, phoneNumber, age, department, salary, hireDate) VALUES
...
INSERT INTO Customer (name, email, phoneNumber, age, favoriteGenre) VALUES
    ('Alice Johnson', 'alice.johnson@example.com', '111-222-3333', 28, 'ROMANCE'),
    ('Bob Martinez', 'bob.martinez@example.com', '222-333-4444', 35, 'ACTION'),
    ('Charlie Lee', 'charlie.lee@example.com', '333-444-5555', 42, 'SCI_FI'),
    ('Diana Cooper',  'diana.cooper@example.com', '444-555-6666', 30, 'DRAMA'),
    ('Ethan Wright', 'ethan.wright@example.com', '555-666-7777', 25, 'ANIMATION');
